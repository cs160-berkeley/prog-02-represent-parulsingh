...
public class CurrentVoteFragment extends CardFragment {

    @Override
    public View onCreateContentView(LayoutInflater inflater,ViewGroup container, Bundle args) {
        View view = inflater.inflate(R.layout.current_vote_fragment_layout, container, false);
    ...
    public static CardFragment create(String data) {
        CardFragment fragment = new CurrentVoteFragment();
